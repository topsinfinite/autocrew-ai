...
export default function TermsPage() {
  return (
    <div>
      ...
      <h3
        id="ai-use-restrictions"
        className="mb-3 text-xl font-semibold text-foreground"
      >
        AI-Specific Use Restrictions
      </h3>
      <p className="mb-4 text-muted-foreground">
        In addition to the general acceptable use policy above, you agree not
        to:
      </p>
      <ul className="mb-8 list-disc space-y-2 pl-6 text-muted-foreground">
        <li>
        ...
        <li>
          Use AI Crews for deceptive impersonation — misrepresenting
          AI-generated content as human-authored where disclosure is required by
          law
        </li>
        <li>
      ...
      <p className="mb-8 text-muted-foreground">
        ...
        at the end of the current billing period. We reserve the right to
      ...
      <ul className="mb-8 list-disc space-y-2 pl-6 text-muted-foreground">
        ...
        <li>
          ...
          decompile, or otherwise attempt to derive the architecture, weights,
          or training data of our AI models
        </li>
        <li>
      ...
      <p className="mb-8 text-muted-foreground">
        For customer data processed through AI crews, you act as the data
        controller and we act as the data processor. You are responsible for
        ensuring you have the necessary rights and consents to process such
        data. For details on our security practices and regulatory compliance,
        see our{" "}
      ...
      <p className="mb-4 text-muted-foreground">
        While we strive for high availability, we do not guarantee that the
        Service will be uninterrupted or error-free. We reserve the right to
      ...
      <p className="mb-8 text-muted-foreground">
        AI Crews are provided "as is" without warranties of any kind. While our
        AI systems are designed to be accurate and helpful, they may make errors
        or produce unexpected results. You are responsible for reviewing and
      ...
      <ul className="mb-8 list-disc space-y-2 pl-6 text-muted-foreground">
        ...
        <li>
          We are not liable for damages arising from unauthorized access, data
      ...
      <p className="mb-8 text-muted-foreground">
        ...
        you of material changes via email or through the Service. Your continued
      ...
      <p className="mb-8 text-muted-foreground">
        ...
        with the rules of the American Arbitration Association, except that you
