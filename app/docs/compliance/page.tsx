  ...
  return (
    <div>
      ...
      <p className="mb-8 text-lg text-muted-foreground">
        ...
        across the jurisdictions we operate in. This page outlines our compliance
        posture and the frameworks we adhere to.
      </p>

      {/* Compliance Overview */}
      <h2 id="compliance-overview" className="mb-4 text-2xl font-semibold text-foreground">
        Compliance Overview
      </h2>
      ...
      <ul className="mb-8 list-disc space-y-2 pl-6 text-muted-foreground">
        <li>
          <strong>Continuous monitoring:</strong> Automated compliance monitoring
          tools that track our adherence to regulatory requirements in real time
        </li>
        <li>
      ...
      <h3 id="gdpr-rights" className="mb-3 text-xl font-semibold text-foreground">
        Data Subject Rights
      </h3>
      <p className="mb-4 text-muted-foreground">
      ...
      <ul className="mb-6 list-disc space-y-1 pl-6 text-muted-foreground">
        ...
        <li>Request erasure of personal data (&quot;right to be forgotten&quot;)</li>
        ...
        <li>Not be subject to solely automated decisions with legal or significant effects</li>
      </ul>
      ...
      <h3 id="gdpr-by-design" className="mb-3 text-xl font-semibold text-foreground">
        Data Protection by Design
      </h3>
      <ul className="mb-6 list-disc space-y-1 pl-6 text-muted-foreground">
        <li>Privacy impact assessments conducted for new features and processing activities</li>
        <li>Data minimization principles applied across all data collection points</li>
      ...
      <h3 id="gdpr-transfers" className="mb-3 text-xl font-semibold text-foreground">
      ...
      <h3 id="ccpa-categories" className="mb-3 text-xl font-semibold text-foreground">
      ...
      <ul className="mb-6 list-disc space-y-1 pl-6 text-muted-foreground">
        ...
        <li>Internet activity (usage logs, feature interactions, IP addresses)</li>
      ...
      <h3 id="ccpa-do-not-sell" className="mb-3 text-xl font-semibold text-foreground">
      ...
      <h3 id="ccpa-service-provider" className="mb-3 text-xl font-semibold text-foreground">
      ...
      <p className="mb-4 text-muted-foreground">
        AutoCrew&apos;s security controls are aligned with the SOC 2 Trust Service
        Criteria established by the American Institute of Certified Public
        Accountants (AICPA).
      </p>
      <ul className="mb-6 list-disc space-y-2 pl-6 text-muted-foreground">
        <li>
      ...
      <p className="mb-4 text-muted-foreground">
        AutoCrew&apos;s Information Security Management System (ISMS) is aligned with
      ...
      <ul className="mb-8 list-disc space-y-2 pl-6 text-muted-foreground">
        ...
        <li>
          ...
          ISO 27001 Annex A covering areas including access control, cryptography,
      ...
      {/* AI Regulations */}
      <h2 id="ai-regulations" className="mb-4 text-2xl font-semibold text-foreground">
      ...
      <ul className="mb-6 list-disc space-y-1 pl-6 text-muted-foreground">
        ...
        <li>Transparency obligations — clear disclosure when users interact with AI systems</li>
        <li>Human oversight mechanisms for AI-driven decisions</li>
        <li>Technical documentation of AI system capabilities and limitations</li>
        <li>Ongoing monitoring for bias, accuracy, and robustness in AI outputs</li>
      </ul>

      <h3 id="responsible-ai" className="mb-3 text-xl font-semibold text-foreground">
      ...
      <ul className="mb-8 list-disc space-y-2 pl-6 text-muted-foreground">
        ...
        <li>
          <strong>Model governance:</strong> Formal review and approval processes
          for AI model deployment and updates
        </li>
      </ul>
      ...
      <ul className="mb-8 list-disc space-y-1 pl-6 text-muted-foreground">
        <li>DPIAs conducted before deploying new AI features or processing activities</li>
        <li>Assessments cover data flows, risk identification, and mitigation measures</li>
        <li>Regular reviews of existing DPIAs as processing activities evolve</li>
        <li>Summary findings available to enterprise customers upon request</li>
      </ul>

      {/* Subprocessors */}
      <h2 id="subprocessors" className="mb-4 text-2xl font-semibold text-foreground">
      ...
      <ul className="mb-8 list-disc space-y-2 pl-6 text-muted-foreground">
        ...
        <li>
          ...
          days before any material change to subprocessors that handle their data
        </li>
        <li>
      ...
      {/* Certifications */}
      <h2 id="certifications" className="mb-4 text-2xl font-semibold text-foreground">
      ...
      {/* Contact */}
      <h2 id="contact-compliance" className="mb-4 text-2xl font-semibold text-foreground">
        Contact Us
      </h2>
      <p className="mb-4 text-muted-foreground">
