...
/**
 * Restaurant hero — "Connected by default" briefing.
 *
 * Same editorial vocabulary as the healthcare, coaching, and legal heroes:
 * mono status masthead, asymmetric 8/4 split, integrations spec card on
 * the right rail. Primary action opens the live voice widget.
 */
              ...
              <div className="px-5 py-7 sm:px-7 sm:py-8">
                <ul className="grid gap-x-8 gap-y-4 font-geist text-[15px] leading-[1.55] text-foreground/80 sm:grid-cols-2">
                  ...
                  <li className="flex gap-3">
                    ...
                    />
                    <span>
                      Sends confirmations, reminders, and recovers{" "}
                      <span className="text-foreground">no-shows</span>{" "}
                      automatically.
                    </span>
                  </li>
                  <li className="flex gap-3">
                    ...
                    <span>
                      Captures{" "}
                      <span className="text-foreground">
                        VIPs, allergies, and special occasions
                      </span>{" "}
                      in the note.
                    </span>
                  </li>
                  <li className="flex gap-3">
                    ...
                    <span>
                      Drafts{" "}
                      <span className="text-foreground">review responses</span>{" "}
                      across Google, Yelp, OpenTable, TripAdvisor.
                    </span>
                  </li>
                </ul>
