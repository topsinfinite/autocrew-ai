...
import { restaurantCtaData } from "@/lib/mock-data/restaurant-data";
                ...
                <div className="flex flex-col gap-4 w-full sm:w-auto">
                  ...
                  >
                    <Link href="https://app.autocrew-ai.com/signup">
                      {restaurantCtaData.primaryCta.text}
                      <ArrowRight className="w-4 h-4 group-hover/btn:translate-x-0.5 transition-transform" />
                    </Link>
                  </Button>
                  <Link
              ...
              <div className="flex flex-col lg:flex-row justify-between gap-8 sm:gap-12 lg:gap-24">
                ...
                <div className="flex flex-col max-w-sm gap-6">
                  ...
                  <p className="text-sm leading-relaxed text-muted-foreground font-geist">
                    AI-powered automation for restaurant professionals. Deploy
                    intelligent crews that handle reservations, guest
                    communication, and reviews 24/7.
                  </p>
