...
import { restaurantSteps } from "@/lib/mock-data/restaurant-data";

const delays = ["0s", "1.5s", "3s", "4.5s"];

export function RestaurantHowItWorks() {
  return (
    <section
      id="how-it-works"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-16">
          ...
          <p className="text-lg font-geist text-muted-foreground">
            Get your AI restaurant crew running in four simple steps.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          ...
          {restaurantSteps.map((step, index) => {
            ...
            const isLastCard = index === restaurantSteps.length - 1;
