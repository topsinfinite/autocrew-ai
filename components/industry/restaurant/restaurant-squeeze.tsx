import { restaurantSqueeze } from "@/lib/mock-data/restaurant-data";

/** Three audience-framed scenarios — owner-operator / multi-location / fine-dining. */
export function RestaurantSqueeze() {
  return (
