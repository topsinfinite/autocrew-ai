import { restaurantOutcomes } from "@/lib/mock-data/restaurant-data";

/** Four numbered outcome rows. */
export function RestaurantOutcomes() {
  return (
            ...
            >
              <div className="lg:col-span-2">
                <div className="font-mono text-[11px] uppercase tracking-[0.22em] text-foreground/40">
                  {row.index} /{" "}
                  {restaurantOutcomes.rows.length.toString().padStart(2, "0")}
                </div>
              </div>
