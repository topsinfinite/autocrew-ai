import { homeServicesHandoff } from "@/lib/mock-data/home-services-data";

export function HomeServicesHandoff() {
  return (
          ...
          <div className="lg:col-span-7">
            <div className="overflow-hidden rounded-2xl border border-[var(--border-subtle)] bg-card">
              <div className="hidden grid-cols-12 gap-4 border-b border-[var(--border-subtle)] bg-foreground/[0.025] px-5 py-3 lg:grid">
                {homeServicesHandoff.columns.map((col, i) => (
                  <div
                    key={col}
                    className={
              ...
              <ul className="divide-y divide-[var(--border-subtle)]">
                {homeServicesHandoff.rows.map((row, i) => (
                  <li
                    key={row.condition}
