...
import { homeServicesAskStrip } from "@/lib/mock-data/home-services-data";

/** Mid-page widget surface with home-services-flavoured prompts. */
export function HomeServicesAskStrip() {
  return (
          ...
          <div className="lg:col-span-7">
            <div className="rounded-2xl border border-[var(--border-subtle)] bg-foreground/[0.02] p-5 sm:p-7">
              <ul className="grid gap-2.5 sm:grid-cols-2">
                {homeServicesAskStrip.prompts.map((p) => (
                  <li key={p.label}>
                    <button
                      type="button"
