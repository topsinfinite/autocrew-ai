import { homeServicesOutcomes } from "@/lib/mock-data/home-services-data";

export function HomeServicesOutcomes() {
  return (
            ...
            >
              <div className="lg:col-span-2">
                <div className="font-mono text-[11px] uppercase tracking-[0.22em] text-foreground/40">
                  {row.index} /{" "}
                  {homeServicesOutcomes.rows.length.toString().padStart(2, "0")}
                </div>
              </div>
