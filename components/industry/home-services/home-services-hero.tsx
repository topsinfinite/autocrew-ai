...
import { homeServicesHeroData } from "@/lib/mock-data/home-services-data";
...
export function HomeServicesHero() {
  const {
    ...
    primaryCta,
    secondaryCta,
  } = homeServicesHeroData;
  const badgeIcon = { phone: Phone, wrench: Wrench, shield: ShieldCheck };
        ...
        <div className="mt-10 grid gap-4 lg:mt-12 lg:grid-cols-12">
            ...
            <div className="rounded-2xl border border-[var(--border-subtle)] bg-card">
              <div className="flex items-center justify-between gap-4 border-b border-[var(--border-subtle)] bg-foreground/[0.025] px-5 py-3">
                <div className="flex items-center gap-3 font-mono text-[10px] uppercase tracking-[0.18em] text-foreground/55">
                  <Wrench className="h-3.5 w-3.5 text-[#FF6B35]" aria-hidden />
              ...
              <div className="px-5 py-7 sm:px-7 sm:py-8">
                <ul className="grid gap-x-8 gap-y-4 font-geist text-[15px] leading-[1.55] text-foreground/80 sm:grid-cols-2">
                  <li className="flex gap-3">
                    ...
                    />
                    <span>
                      Triages emergencies from routine calls{" "}
                  ...
                  <li className="flex gap-3">
                    ...
                    <span>
                      Dispatches{" "}
                      <span className="text-foreground">
                        live to the on-call tech
                      </span>{" "}
                      in ServiceTitan, Housecall Pro, Jobber, or Workiz.
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span
                    ...
                    <span>
                      ...
                      end-to-end — no shift gaps, no voicemail.
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span
                    ...
                    <span>
                      Hands{" "}
                      <span className="text-foreground">
                        complex bids and disputes
                      </span>{" "}
                      back to a human with full context.
                    </span>
                  </li>
                </ul>
          ...
          <aside className="min-w-0 lg:col-span-4">
            <div className="flex h-full flex-col gap-5 rounded-2xl border border-[var(--border-subtle)] bg-foreground/[0.02] p-5 lg:p-6">
              ...
              <p className="mt-auto inline-flex items-center gap-2 font-mono text-[9.5px] uppercase tracking-[0.2em] text-foreground/40">
