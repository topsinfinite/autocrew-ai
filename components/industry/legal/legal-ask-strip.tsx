...
import { legalAskStrip } from "@/lib/mock-data/legal-data";

/** Mid-page widget surface with legal-flavoured prompts. */
export function LegalAskStrip() {
  return (
