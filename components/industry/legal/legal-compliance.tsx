...
import { legalCompliance } from "@/lib/mock-data/legal-data";

/** Compliance ledger — translates the bar-association language into plain English. */
