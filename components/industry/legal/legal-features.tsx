import { UserCheck, MessageSquare, ClipboardList, Check } from "lucide-react";
import { cn } from "@/lib/utils";
import { SectionBadge } from "@/components/landing/section-badge";
import { legalFeaturesData } from "@/lib/mock-data/legal-data";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16 md:mb-20">
          <SectionBadge className="mb-8">
            {legalFeaturesData.badge}
          </SectionBadge>

          <h2 className="text-3xl sm:text-4xl md:text-5xl tracking-tight mb-6 font-space-grotesk font-semibold text-foreground">
            {legalFeaturesData.headline.prefix}{" "}
            <span className="text-[#FF6B35]">
              {legalFeaturesData.headline.accent}
            </span>
          </h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {legalFeaturesData.items.map((feature, index) => {
