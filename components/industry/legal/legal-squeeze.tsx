...
import { legalSqueeze } from "@/lib/mock-data/legal-data";

/**
 * Three audience-framed scenarios (Firm partner / Legal ops / Legal aid).
 * Mostly descriptive — the only number is the LSC Justice Gap citation,
 * which is a real published figure.
 */
export function LegalSqueeze() {
  return (
                ...
                >
                  ...
                  <div className="sm:col-span-9">
                    ...
                    {(item as { citationRef?: boolean }).citationRef ? (
                      <a
                        href={legalSqueeze.citation.href}
                        target="_blank"
                      ...
                      >
                        {legalSqueeze.citation.label}: {legalSqueeze.citation.text}
