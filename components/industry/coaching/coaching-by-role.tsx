import { coachingByRole } from "@/lib/mock-data/coaching-data";

/**
 * Built for the practice you actually run — three editorial columns
 * (Solo / Cohort / Agency).
 */
export function CoachingByRole() {
  return (
