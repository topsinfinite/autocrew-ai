import { coachingSqueeze } from "@/lib/mock-data/coaching-data";

/**
 * Three audience-framed scenarios (Solo / Cohort / Agency).
 *
 * Honest, descriptive — no fabricated stats. Same editorial three-column
 * pattern as the healthcare revenue-leak section.
 */
export function CoachingSqueeze() {
  return (
