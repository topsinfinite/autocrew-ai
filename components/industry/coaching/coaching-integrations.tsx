...
import { coachingIntegrations } from "@/lib/mock-data/coaching-data";

/**
 * Integrations ledger — coaching's equivalent of the healthcare compliance
 * ledger. Mono six-cell grid that calls out the existing tools Autocrew
 * works through, not a separate dashboard the visitor would have to learn.
 */
export function CoachingIntegrations() {
  return (
        ...
        <div className="grid gap-10 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-5">
            ...
            <h2 className="mt-4 font-space-grotesk text-[clamp(1.875rem,3vw,2.75rem)] font-semibold leading-[1.08] tracking-[-0.018em] text-foreground">
              {coachingIntegrations.heading}
            </h2>
            <p className="mt-5 max-w-[44ch] font-geist text-[15px] leading-[1.7] text-foreground/70">
              {coachingIntegrations.body}
            </p>
            <Link
              href={coachingIntegrations.docsLink.href}
            ...
            >
              {coachingIntegrations.docsLink.text}
