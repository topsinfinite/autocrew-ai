import { Calendar, UserCheck, MessageSquare, Check } from "lucide-react";
import { cn } from "@/lib/utils";
import { SectionBadge } from "@/components/landing/section-badge";
import { coachingFeaturesData } from "@/lib/mock-data/coaching-data";
    ...
    <section className="z-10 pt-16 pb-16 sm:pt-24 sm:pb-24 md:pt-32 md:pb-32 relative section-glow-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {coachingFeaturesData.items.map((feature, index) => {
