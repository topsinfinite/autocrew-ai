...
import { coachingSteps } from "@/lib/mock-data/coaching-data";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-16">
          ...
          <p className="text-lg font-geist text-muted-foreground">
            Get your AI coaching crew running in four simple steps.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          ...
          {coachingSteps.map((step, index) => {
            ...
            const isLastCard = index === coachingSteps.length - 1;
