import { coachingOutcomes } from "@/lib/mock-data/coaching-data";

/**
 * Four numbered outcome rows. Editorial layout (large mono index + headline +
 * plain-English body + a single mono integration footnote per row).
 */
export function CoachingOutcomes() {
  return (
            ...
            >
              <div className="lg:col-span-2">
                <div className="font-mono text-[11px] uppercase tracking-[0.22em] text-foreground/40">
                  {row.index} /{" "}
                  {coachingOutcomes.rows.length.toString().padStart(2, "0")}
                </div>
              </div>
