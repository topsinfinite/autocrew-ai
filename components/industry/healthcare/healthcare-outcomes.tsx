import { healthcareOutcomes } from "@/lib/mock-data/healthcare-data";

/**
 * Four numbered outcome rows. Editorial layout (large mono index + headline +
 * plain-English description + a single mono compliance footnote per row) so
 * the page reads like a briefing, not a feature list.
 */
export function HealthcareOutcomes() {
  return (
            ...
            >
              <div className="lg:col-span-2">
                <div className="font-mono text-[11px] uppercase tracking-[0.22em] text-foreground/40">
                  {row.index} / {healthcareOutcomes.rows.length
                    .toString()
                    .padStart(2, "0")}
                </div>
              </div>
              ...
              <div className="lg:col-span-4 lg:pl-8 lg:border-l lg:border-[var(--border-subtle)]">
