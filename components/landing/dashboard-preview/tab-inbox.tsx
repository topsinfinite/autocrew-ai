...
import type {
  InquiryChannel,
  InquiryStatus,
} from "@/lib/mock-data/landing-data";
...
export function TabInbox() {
  ...
  const filtered =
    activeFilter === "All"
      ? inquiries
      : inquiries.filter((i) => i.channel === activeFilter);
    ...
    <div className="flex-1 flex flex-col animate-fade-in-up">
            ...
            >
              ...
              <div className="flex items-center justify-between mb-1.5">
                <div className="flex items-center gap-2">
                  ...
                  <div
                    className={`flex items-center gap-1 ${channel.bgColor} border ${channel.borderColor} rounded-full px-2 py-0.5`}
                  >
                    <ChannelIcon
      ...
      <div className="px-5 py-3 border-t border-white/[0.05] flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-4">
          <span className="font-space-mono text-[10px] text-neutral-600">
            {filtered.length} inquiries &middot; {activeCount} active
          </span>
        </div>
        <div className="flex items-center gap-2">
