...
import { AutocrewSearchStyles } from "./autocrew-search-styles";
import { HeroArchitectural } from "./hero-architectural";
import { HeroConversational } from "./hero-conversational";
import { HeroDialogue } from "./hero-dialogue";
...
const VARIANTS: VariantMeta[] = [
  { id: "a", title: "Dialogue", subtitle: "Editorial Exchange" },
  { id: "b", title: "Architectural", subtitle: "Infrastructure, Made Human" },
  { id: "c", title: "Conversational", subtitle: "Live Stream Canvas" },
];

const DEFAULT_VARIANT: VariantId = "b";
...
function renderVariant(id: VariantId) {
  switch (id) {
    case "a":
      return <HeroDialogue />;
    case "c":
      return <HeroConversational />;
    case "b":
    default:
      return <HeroArchitectural />;
  }
}
...
export function HeroVariantSwitcher() {
  ...
  // Render default on SSR; picker mounts client-only.
        ...
        >
          {open && (
            <div
              ...
              role="listbox"
              aria-label="Hero design variant"
            >
