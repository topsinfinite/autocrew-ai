    ...
    <section id="how-it-works" className="z-10 pt-40 pb-40 relative">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          {/* Moving Beam Line */}
          <div className="hidden lg:block absolute top-[25.5px] left-0 w-full h-px overflow-hidden rounded-full pointer-events-none bg-foreground/[0.05] dark:bg-white/5">
          ...
          {howItWorksData.map((step, index) => {
            ...
            return (
              ...
              >
                {/* Dot Indicator */}
                <div
                  className="w-3 h-3 rounded-full ring-4 ring-background absolute top-5 left-0 lg:-mt-0.5 z-10 animate-dot-pulse transition-all duration-300 bg-foreground/10 dark:bg-white/10"
                  style={{ animationDelay: delay }}
                />

                {/* Step Number */}
                <div
                  className="text-7xl font-semibold font-space-grotesk mb-4 animate-num-pulse transition-colors duration-300 text-foreground/[0.05] dark:text-white/5"
                  style={{ animationDelay: delay }}
                >
                  {step.number}
                </div>
