...
import { aiReceptionistFaqItems } from "@/lib/mock-data/ai-receptionist-data";

export function AiReceptionistFaq() {
  return (
    <section
      id="faq"
      className="relative z-10 section-divider section-glow-center pt-16 pb-16 sm:pt-24 sm:pb-24 md:pt-32 md:pb-32 scroll-mt-24"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
          <div className="lg:col-span-5">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl tracking-tight mb-6 font-semibold text-foreground font-space-grotesk">
              Questions before you pilot Sarah
            </h2>

            <p className="text-lg leading-relaxed text-muted-foreground font-geist mb-8">
              Straight answers on handoff, compliance scope, and what AI should
              never pretend to do.
            </p>
          ...
          <div className="lg:col-span-7 rounded-3xl border border-border bg-foreground/[0.02] dark:bg-white/[0.02] backdrop-blur-sm p-6 md:p-8">
            <Accordion type="single" collapsible className="w-full">
              {aiReceptionistFaqItems.map((item, index) => (
                <AccordionItem
                  key={item.question}
                  value={`ai-rec-faq-${index}`}
